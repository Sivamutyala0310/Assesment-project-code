...
public class ConstantFilePaths 
{
	...
	public final static String LOCATORS_FILE = locators_Home + "atmecswebsite_locators.properties";


	public final static String testData_Home = homeDir + "src\\test\\resources"+ File.separator + "testdata" + File.separator;
	public final static String TESTDATA_FILE = testData_Home + "atmecssitetestdata.xlsx";
